...
const Estimate = () => {
  ...
  const { name, phoneNumber, emailId, customMessage } = field;

  const [service, setService] = useState([]);
  const [platforms, setPlarforms] = useState([]);
  ...
  const navigationPreviosDisabled = () => {
      ...
      <Grid item container alignItems="center">
        <Grid item>
          <img
            src={check}
            alt="checkmark"
            style={{ maxWidth: "1.5rem", marginRight: "1.2rem" }}
          />
        </Grid>
        <Grid item style={{ maxWidth: matchesSM ? "15rem" : "25rem" }}>
          <Typography
            variant="body1"
            style={{ fontSize: matchesSM ? "1rem" : "1.1rem" }}
          >
            You want {service}
            {platforms.length > 0
              ? ` for ${
    ...
    <Grid container direction="column">
      <Grid item container alignItems="center">
        ...
        <Grid item>
          <Typography
            variant="body1"
            style={{ fontSize: matchesSM ? "1rem" : "inherit" }}
          >
            You want{" "}
            {category === "Basic"
              ? "a Basic Website"
    ...
    <>
      <Grid container direction={matchesMD ? "column" : "row"}>
        ...
        <Grid
          ...
          direction="column"
          lg
          style={{ marginRight: "2rem", marginBottom: "20rem" }}
          alignItems="center"
        >
          {questions
                ...
                >
                  <Grid item>
                    <IconButton
                      ...
                      disabled={navigationPreviosDisabled()}
                    >
                      <img
                        src={
                          navigationPreviosDisabled()
                            ? backArrowDisabled
                            : backArrow
                        }
                        alt="back arrow"
        ...
        <Dialog
          ...
          style={{ zIndex: 1500 }}
          PaperProps={{ style: { maxWidth: "60rem" } }}
        >
            ...
            <Grid container direction={matchesSM ? "column" : "row"}>
              ...
              >
                ...
                <Grid
                  item
                  style={{
                    maxWidth: matchesSM ? "20rem" : undefined,
                    marginTop: "3rem",
                  }}
                >
                  <Typography
                  ...
                  <Typography
                    ...
                    align={matchesSM ? "center" : "inherit"}
                  >
                    Fill out your name, email, phone number, place your request,
              ...
              <Grid
                ...
                alignItems="center"
                md={7}
                style={{ paddingLeft: matchesSM ? 0 : "2.5rem" }}
              >
                <Grid item style={{ marginTop: "3rem" }}>
                  {questions.length > 2 ? softwareSelection : websiteSelction}
                </Grid>
